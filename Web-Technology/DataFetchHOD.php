...
if($numRow>0){
    ...
    while($row=mysqli_fetch_assoc($result)){
        ...
        echo "<td><a class='acceptButton' href='hodPage.php?reg=".$row['Regno']."&date=".$row['ODstDate']."&sts=1'><i class='bi bi-hand-thumbs-up' style='color: blue; padding-left:40%;'></i></a></td>";
        echo "<td><a href='hodPage.php?reg=".$row['Regno']."&date=".$row['ODstDate']."&sts=0'><i class='bi bi-hand-thumbs-down' style='color: red; padding-left:40%'></i></a></td>";
        echo '</tr>';
